    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 px-6 text-center">
            ...
            <p className="text-gray-600 mt-3">
                Ваше обращение отправлено. Мы скоро свяжемся с вами.
            </p>

            <button
                onClick={() => router.back()}
                className="mt-16 px-6 py-3 rounded-4xl bg-primary text-white font-semibold hover:bg-primary/80 transition"
            >
                На главную
            </button>
        </div>
