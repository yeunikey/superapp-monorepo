...
function ProfileInfo() {
    ...
    return (
        <View className="w-full flex items-center justify-center mt-16 gap-2">
            <Text className='text-3xl font-semibold'>{loggedStudent?.name + " " + loggedStudent?.surname}</Text>
            <View className='flex flex-row gap-4'>
                <Text className='text-muted-foreground py-1.5 px-4 bg-red font-semibold text-white rounded-full'>Разработчик</Text>
                <View className='flex flex-row gap-1 items-center'>
                    <Text className='font-semibold text-secondary text-lg'>24</Text>
